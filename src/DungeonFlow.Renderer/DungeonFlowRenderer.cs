namespace DungeonFlow.Renderer
{
	public partial class DungeonFlowRenderer : Form
	{
		...
		{
			RoomConfig[] rooms = [
				new(r => r.Next(16, 16), r => r.Next(14, 16), r => 0, LinkDirectionMask.All, GetRandomHallPosition, null),
				new(r => r.Next(18, 24), r => r.Next(18, 24), r => 0, LinkDirectionMask.All, GetRandomHallPosition, null),
				new(r => 32, r => 32, r => 1, LinkDirectionMask.All, GetRandomHallPosition, null),
			];
